	...
	public JSONObject getPlaceDetail (int dest_id, int content_type) {
		...
		try {
			...
			case 12: // 관광지
		        ...
		        result.put("age", item.optString("expagerange", "")); //체험가능연령
		        result.put("expguide", item.optString("expguide", "")); //체험안내
		        result.put("opendate", item.optString("opendate", "")); //개장일
		        break;
		    ...
		    case 38: // 쇼핑
		        result.put("saleitem", item.optString("saleitem", "")); //판매품목
